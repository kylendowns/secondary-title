 ...
 * @deprecated
 */
function get_secondary_title_link($post_id = 0, $prefix = "", $suffix = "", $use_settings = false, array $options = []) {
 ...
 * @since 0.5.0
 */
function the_secondary_title_link($post_id = 0, $prefix = "", $suffix = "", $use_settings = false, array $options = []) {
    _deprecated_function(
